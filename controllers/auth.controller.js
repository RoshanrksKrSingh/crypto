...
const register = async (req, res) => {
  ...
  try {
    ...
    // const hashedPassword = await bcrypt.hash(password, 10); // No longer needed
    ...
    const tempOtp = new TempOtp({
      ...
      lastName,
      phone,
      password, // Raw password; model will hash it when final User is created
      role,
...
const verifyRegistrationOTP = async (req, res) => {
  ...
  try {
    ...
    const user = new User({
      ...
      password: tempOtpRecord.password, // Already raw; will be hashed by model
...
const login = async (req, res) => {
  ...
  try {
    ...
    // Use instance method if available, otherwise keep bcrypt
...
const resetPassword = async (req, res) => {
  ...
  try {
    ...
    // const hashedPassword = await bcrypt.hash(newPassword, 10); // Not needed anymore
